...
export class RunService {
  ...
  CreateRun(input: CreateRunInput, opts?: any): Promise<CreateRunOutput> {
    const path = "/problems/"+encodeURIComponent(input.problemId||'')+"/runs";
  ...
  DescribeRun(input: DescribeRunInput, opts?: any): Promise<DescribeRunOutput> {
    const path = "/problems/"+encodeURIComponent(input.problemId||'')+"/runs/"+encodeURIComponent(input.runId||'');
  ...
  WatchRun(input: WatchRunInput, opts?: any): _Stream<WatchRunOutput> {
    const path = "/problems/"+encodeURIComponent(input.problemId||'')+"/runs/"+encodeURIComponent(input.runId||'')+"/watch";
