...
import { Result, ResultV2 } from "./result"
...
export class ScoreService {
  ...
  ListResults(input: ListResultsInput, opts?: any): Promise<ListResultsOutput> {
    const path = "/results-v2";
