...
import { Fragment, Fragment_Patch } from "../content/content_fragment"
...
export class ContentService {
  ...
  DescribeFragment(input: DescribeFragmentInput, opts?: any): Promise<DescribeFragmentOutput> {
    const path = "/contests/"+encodeURIComponent(input.contestId||'')+"/content/fragments/"+encodeURIComponent(input.fragmentId||'');
  ...
  ListFragments(input: ListFragmentsInput, opts?: any): Promise<ListFragmentsOutput> {
    const path = "/contests/"+encodeURIComponent(input.contestId||'')+"/content/fragments";
  ...
  TranslateFragment(input: TranslateFragmentInput, opts?: any): Promise<TranslateFragmentOutput> {
    const path = "/contests/"+encodeURIComponent(input.contestId||'')+"/content/fragments/"+encodeURIComponent(input.fragmentId||'')+"/translate";
  ...
  DescribePath(input: DescribePathInput, opts?: any): Promise<DescribePathOutput> {
    const path = "/contests/"+encodeURIComponent(input.contestId||'')+"/content/path";
  ...
  ListParents(input: ListParentsInput, opts?: any): Promise<ListParentsOutput> {
    const path = "/contests/"+encodeURIComponent(input.contestId||'')+"/content/parents";
